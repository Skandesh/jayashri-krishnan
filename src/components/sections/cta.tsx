      ...
      <div className="py-14 container mx-auto px-4 max-w-[1000px] ">
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden rounded-[2rem] border p-10 py-14">
          ...
          <div className="z-10 mt-4 flex flex-col items-center text-center text-black dark:text-white">
            ...
            <p className="mt-2 max-w-lg">Transform your business or start your organic living journey. Get in touch for consultation and training programs.</p>
            <div className="mt-6 space-y-2 text-sm">
              <p><strong>Email:</strong> {siteConfig.links.email}</p>
              <p><strong>Phone:</strong> {siteConfig.links.phone} / {siteConfig.links.phone2}</p>
            ...
            <Link
              ...
              className={cn(
                ...
                "h-10 px-6 text-white rounded-full group mt-6"
              )}
            >
              {siteConfig.cta}
